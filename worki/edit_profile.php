...
<?php include('session.php'); ?>    
	...
	<hr>
	Celular:<input name="mobile" type="text" value="<?php echo $row['mobile']; ?>">
	<hr>
	Cargo:<input name="work" type="text" value="<?php echo $row['work']; ?>">
	<hr>
	Hobbies:<input name="hobbies" type="hobbies" value="<?php echo $row['hobbies']; ?>">
	<hr>
	<br>
			<center>

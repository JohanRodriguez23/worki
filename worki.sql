...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2021 a las 02:51:37
...
INSERT INTO `members` (`member_id`, `firstname`, `lastname`, `middlename`, `address`, `email`, `contact_no`, `age`, `gender`, `username`, `password`, `image`, `birthdate`, `mobile`, `status`, `work`, `hobbies`) VALUES
...
(14, 'Maycol', 'Paez', '', '', '', '', 0, 'Hombre', 'mjavier', 'michaelpaez24', 'images/2021-11-23 (6).png', '', '', '', '', ''),
(15, 'sdfsdf', 'sdfsdf', '', '', '', '', 0, 'Mujer', 'ddfgdfg', '1234', 'images/No_Photo_Available.jpg', '', '', '', '', '');
